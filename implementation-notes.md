...
- Plain Transformers generation did not obey the approved JSON envelope. Constrained decoding is proposed but remains unapproved and is not part of this checkpoint.
